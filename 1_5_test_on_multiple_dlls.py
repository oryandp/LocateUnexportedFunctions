...
ntdll_files_x64 = [
(os.path.join(DLLS_BASE_DIR, r'64\ntdll_1507_x64.dll'), "Win10_1507_x64", True, "74 33 44 8D 43 09", 0x44),
(os.path.join(DLLS_BASE_DIR, r'64\ntdll_1511.dll'), "Win10_1511_x64", True, "74 33 44 8D 43 09", 0x44),
(os.path.join(DLLS_BASE_DIR, r'64\ntdll_1607.dll'), "Win10_1607_x64", True, "74 33 44 8D 43 09", 0x44),
